...
const seoCopy = {
  EN: {
    ...
    privacy: ["Privacy Policy | Tammuz Medical", "How Tammuz Medical handles quote requests, contact information and optional website analytics."],
  ...
  TR: {
    ...
    privacy: ["Gizlilik Politikası | Tammuz Medical", "Teklif talepleri, iletişim bilgileri ve isteğe bağlı analizlerin nasıl işlendiği."],
  ...
  AR: {
    ...
    privacy: ["سياسة الخصوصية | Tammuz Medical", "كيفية التعامل مع طلبات عروض الأسعار وبيانات التواصل وتحليلات الموقع الاختيارية."],
