...
function Home({ country }: { country: string }) {
  return <>
    <section className="hero"><div className="hero-copy"><Eyebrow>Italian dental expertise, locally supplied</Eyebrow><h1>Premium Dental Supplies for Turkish Clinics &amp; Distributors</h1><p className="lede">Tammuz Global Medical is a trusted B2B partner for clinics, distributors and procurement teams across {country}. Source quality-led AsaDental products with a clear, responsive supply process.</p><div className="buttons"><a className="button primary" href={WHATSAPP_URL} target="_blank" rel="noreferrer">Chat on WhatsApp ↗</a><a className="button" href="/catalog.html">View Full Catalog ↓</a></div><div className="stats"><b>2,959<small>AsaDental references available</small></b><b>2<small>Regional operating markets</small></b><b>1:1<small>Dedicated account support</small></b></div></div><div className="hero-art hero-showcase"><img className="hero-showcase-image" src="/assets/hero-instrument-collage.png" alt="AsaDental Italian surgical and dental instrument collection"/><div className="hero-showcase-mark"><img src="/assets/brand/asa-dental.png" alt="AsaDental logo"/><span>Professional instruments<br/>Made in Italy</span></div></div></section>
    <Trust />
