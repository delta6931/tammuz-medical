...
const informationCopy: Record<SiteLocale, Record<"privacy" | "terms" | "guide", InformationEntry>> = {
  EN: {
    privacy: {
      ...
      sections: [
        ...
        { title: "Website analytics", paragraphs: ["We use Google Analytics to measure page views, approximate region, device type, catalog searches, tool use and quote or WhatsApp conversion actions. We do not send names, email addresses, telephone numbers or quote-message text to Analytics. Google Signals and advertising personalization are disabled."] },
  ...
  TR: {
    privacy: {
      ...
      updated: "Son güncelleme: 25 Ağustos 2026",
      sections: [
        ...
        { title: "Web sitesi analizi", paragraphs: ["Sayfa görüntülemelerini, yaklaşık bölgeyi, cihaz türünü, katalog aramalarını, araç kullanımını ve teklif ya da WhatsApp dönüşüm işlemlerini ölçmek için Google Analytics kullanırız. Ad, e-posta adresi, telefon numarası veya teklif mesajı metnini Analytics'e göndermeyiz. Google Signals ve reklam kişiselleştirme özellikleri devre dışıdır."] },
  ...
  AR: {
    privacy: {
      ...
      sections: [
        ...
        { title: "تحليلات الموقع", paragraphs: ["نستخدم Google Analytics لقياس مشاهدات الصفحات والمنطقة التقريبية ونوع الجهاز وعمليات البحث في الكتالوج واستخدام الأدوات وإجراءات التحويل عبر طلب عرض السعر أو WhatsApp. لا نرسل الأسماء أو عناوين البريد الإلكتروني أو أرقام الهاتف أو نص رسائل طلب السعر إلى Analytics. تم تعطيل Google Signals وتخصيص الإعلانات."] },
