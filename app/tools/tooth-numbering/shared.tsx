...
import { ToothNotationConverter } from "../../_components/ToothNotationConverter";
import { ToolShell } from "../../_components/ToolShell";
import { localizedPath, type SiteLocale } from "../../_lib/catalog";
import { toothNotationStrings } from "../_strings/tooth-notation";
import "./converter.css";

const TOOL_PATH = "/tools/tooth-numbering";
...
export function buildMetadata(locale: SiteLocale): Metadata {
  const { title, description } = toothNotationStrings[locale].meta;
...
export function ToothNumberingPage({ locale }: { locale: SiteLocale }) {
  const s = toothNotationStrings[locale];

  return (
    <ToolShell locale={locale} labels={s.shell}>
      <section className="section">
        <ToothNotationConverter locale={locale} />
      </section>
